<template>
  <section class="home">
    <div class="hero">
      <h1 class="tituloHome">Potencia tu negocio con agentes de IA personalizados</h1>
      <p class="textoHome">
        En <strong>DigitRise</strong>, creamos <em>agentes de inteligencia artificial</em> adaptados a las necesidades
    ...
    <div class="info-extra">
      <h3 class="tituloHome">Soluciones inteligentes, listas para implementar</h3>
      <p class="textoHome">
